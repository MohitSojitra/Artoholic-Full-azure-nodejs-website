...
imageRouter.route("/appImage")
    ...
    .post(cors.corsWithOptions,upload.single("appImage"), (req, res, next) => {
        Apps.findOne({
...
imageRouter.route("/bannerImage")
    ...
    .post(cors.corsWithOptions,upload.single("bannerImage"), (req, res, next) => {
...
imageRouter.route("/mediaImage")
    ...
    .post(cors.corsWithOptions,upload.single("mediaImage"), (req, res, next) => {
        Apps.findOne({
                appName: req.body.appName
            })
            .then((app) => {
